...
<div on:click="{makeClick}" class="{classNames ? classNames : ''} flexbox {fixedWidth ? 'fixed-width-' + fixedWidth : ''}" style="justify-content:{justifyContent}; align-items:{alignItems};">
  <slot/>
</div>
