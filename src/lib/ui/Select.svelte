...
.select .options{width:calc(100%);border: 1px solid #222;border-top:0px;border-bottom-right-radius:3px;border-bottom-left-radius:3px;padding:0px 14px;padding-bottom:10px;}
