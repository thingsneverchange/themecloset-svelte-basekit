...
.select .options{top:35px;width:calc(100% + 2px);left:-1px;position:absolute;;border: 1px solid #222;border-top:0px;border-bottom-right-radius:3px;border-bottom-left-radius:3px;padding:0px 15px;padding-bottom:10px;z-index:9999}
